...
2, The value of each '..._id' column can be multiple items from the same '..._id' column of upload_lookup.csv. If there are multiple items, please ONLY USE COMMA as delimiter. For example, 'TV,Paid Search'.
